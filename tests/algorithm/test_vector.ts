...
export function test(): t.OkNg {
    const v2 = vc.v2(1,2);
    const v3 = vc.v3(1,2,3);
    const v4 = vc.v4(1,2,3,4);
    ...
    return t.printModule('algeol/math/vector', [
        ...
        {group: 'arithmetic', results: t.tests([
            ...
            t.dataNumArray('v2.hadamart(v2)', v2.el_mul(v2).array(), [1,4]),
            t.dataNumArray('v3.hadamart(v3)', v3.el_mul(v3).array(), [1,4,9]),
            t.dataNumArray('v4.hadamart(v4)', v4.el_mul(v4).array(), [1,4,9,16]),
