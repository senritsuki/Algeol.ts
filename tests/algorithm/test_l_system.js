...
var fs = require('fs');
var ls = require("../../algorithm/l_system");
var svg = require("../../decoder/svg");
...
function test() {
    ...
    writeSvg('KochCurve60', ls.presets.KochCurve60.start, 4, function (vl, _rec) { return ls.presets.KochCurve60.turtle(vl, 10); });
    writeText('KochCurve90', ls.presets.KochCurve90.start, 4);
    writeSvg('KochCurve90', ls.presets.KochCurve90.start, 4, function (vl, _rec) { return ls.presets.KochCurve90.turtle(vl, 10); });
    writeText('KochIsland', ls.presets.KochIsland.start, 4);
    writeSvg('KochIsland', ls.presets.KochIsland.start, 4, function (vl, _rec) { return ls.presets.KochIsland.turtle(vl, 10); });
    writeText('PeanoCurve', ls.presets.PeanoCurve.start, 4);
    writeSvg('PeanoCurve', ls.presets.PeanoCurve.start, 4, function (vl, _rec) { return ls.presets.PeanoCurve.turtle(vl, 10); });
    writeText('PeanoGosperCurve', ls.presets.PeanoGosperCurve.start, 4);
    writeSvg('PeanoGosperCurve', ls.presets.PeanoGosperCurve.start, 4, function (vl, _rec) { return ls.presets.PeanoGosperCurve.turtle(vl, 10); });
    writeText('SierpinskiArrowheadCurve', ls.presets.SierpinskiArrowheadCurve.start, 4);
    writeSvg('SierpinskiArrowheadCurve', ls.presets.SierpinskiArrowheadCurve.start, 4, function (vl, _rec) { return ls.presets.SierpinskiArrowheadCurve.turtle(vl, 10); });
    writeText('SierpinskiTriangle', ls.presets.SierpinskiTriangle.start, 4);
    writeSvg('SierpinskiTriangle', ls.presets.SierpinskiTriangle.start, 4, function (vl, _rec) { return ls.presets.SierpinskiTriangle.turtle(vl, 10); });
    writeText('SquareCurve', ls.presets.SquareCurve.start, 4);
    writeSvg('SquareCurve', ls.presets.SquareCurve.start, 4, function (vl, _rec) { return ls.presets.SquareCurve.turtle(vl, 10); });
    writeText('DragonCurve', ls.presets.DragonCurve.start, 12);
    writeSvg('DragonCurve', ls.presets.DragonCurve.start, 12, function (vl, _rec) { return ls.presets.DragonCurve.turtle(vl, 10); });
}
test();
